...
<div class="square">
	<form method="post" action="Studfileup" enctype="multipart/form-data" autocomplete="off">
		<center>
		...
		<tr><td></td><td><button class="button" onClick="(<head><body><script>alert('file uploaded Successfully..')</script></body></head>)">UPLOAD</button></td></tr>		
		</table></center>
	</form>
	</div>
