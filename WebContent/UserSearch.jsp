q	<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
...
<body>
	...
	<hr>
<div class="hei">
<center><h3 style="Padding-top:20px;color: white;font-weight:bold;text-decoration:underline">DATA SEARCH</h3></center>

<form action="UserSearch2.jsp" method="post" autocomplete="off">
	<center> <table id="customers">
		<tr><th>SEMANTIC DATA</th></tr>
		<tr><th><input type="text" name="semantic" id="sem" required placeholder="Enter Semantic Information"></th></tr>
		<tr><td><button class="button">GENERATE TRAPDOOR</button></td></tr>
	</table></center>
	</form>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<div class="modal-body">
						<img src="images/Clibg.jpg" alt=" " class="img-responsive" />
