...
.button6 {border-radius: 30%;}
  ...
  <div class="content">
    ...
    <div class="container">
      <h2 class="mb-5"><center>Department Details</center></h2>
      

      <div class="table-responsive">
<center><button class="button button5"><a href="depthomepg.html">HOME</a></button></center>
        <table class="table table-striped custom-table">
          ...
          <%
							...
							try
						    {
								String qry4 = "SELECT * FROM depttbl";
                       ...
                       <td><%=r.getString(5) %></td>
                        <td><%=r.getString(6) %></td>
                         ...
                         <td><%=r.getString(13) %></td>
                      	 <form action="deptidreq.jsp" method="post" >
                         	<input type="hidden" name="em" value="<%=r.getString(11) %>">
