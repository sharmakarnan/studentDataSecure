...
<body>
	...
	<hr>
<div class="hei">
<center><h3 style="Padding-top:20px;color: white;font-weight:bold;text-decoration:underline">SEARCH USING TRAPDOOR</h3></center>

<%
String semantic = request.getParameter("semantic");
String trap = SHA256.getcode(semantic);

%>
<form action="UserSearch3.jsp" method="post">
	<center> <table id="customers">
		<tr><th>SEMANTIC DATA</th></tr>
		<tr><td><input type="text" name="search" id="sem" value="<%=semantic %>" placeholder="Semantic Data" readonly></td></tr>
		<tr><th>TRAPDOOR</th></tr>
		<tr><td><input type="text" name="trap" id="trap" value="<%=trap %>" required readonly ></td><td><button class="button">SEARCH</button></td></tr>
	</table></center>
	</form>
...
<div class="copy-right wow fadeInLeft animated" data-wow-delay=".5s">
	<div class="container">
			<p> &copy; 2018 Corp Deal . All Rights Reserved </a></p>
	</div>
</div>
<!-- //footer -->
