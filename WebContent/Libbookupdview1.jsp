...
<title>Library Request Accept</title>
<body>
<video src="video/sample.mp4" type="video/mp4" autoplay loop playsinline muted></video>
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-4">
					<h2 class="heading-section" style="color='white'">Request List</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<h3 class="h5 mb-4 text-center"><a  href="Libraryhomepg.html">Home</a></h3>
					<%-- <center>
      ...
      <tr>
        ...
        <td>
        <form method="post" action="Libacptstsupd.jsp">
