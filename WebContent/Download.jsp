...
<center><h3 style="Padding-top:20px;color: red;background-color: Lightblue;font-weight:bold;">ENTER KEY</h3></center>
...
try {
		...
		String qry ="SELECT * FROM udata WHERE id='"+fid+"'"; 
...
<form action="Download2.jsp" method="post" autocomplete="off">
	<center> <table id="customers">
	<input type="hidden" value=<%=fid%> name="fid">
		<tr><th>FID</th><td><%=fid %></td></tr>
		<tr><th>DATA</th><td><textarea rows="6" cols="20" readonly><%=rs.getString("enc") %></textarea></td></tr>
		<tr><th>KEY</th><td><input type="text" placeholder="Enter Decryption Key" name="deckey"></td><td><input type="submit" value="DECRYPT"></td></tr>
	</table></center>
	</form>
