			...
			<div class="content-wthree1">
				<div class="grid-agileits1">
					...
					<!-- <input type="hidden" value= name="fid"> -->
						...
						<input type="text"  name="name" placeholder="Enter name" required=""></div>
						
						<div class="form-control">	
						<label class="header" >Author<span>*</span></label>
						<input type="text"  name="auth" placeholder="Enter Author" required=""></div>
						
						<div class="form-control">	
						<label class="header" >Year of Publish<span>*</span></label>
						<input type="text"  name="year" placeholder="Enter publish year" required=""></div>
						
				<div class="wthreesubmitaits">
					<button><a style="color:red;font-weight:bold;font-size:20px;">REQUEST</a></button>
				</div>
				<div class="wthreesubmitaits">
