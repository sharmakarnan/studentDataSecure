...
width:200px;
	...
	<section class="ftco-section">
		...
		</div><center><button type="button" onclick="alert('Upload Successfull')"><a href="index.html">SEND</a></button></center>
		<br><br><br><br>
		</div><center><button type="button" ><a href="UserSearch.jsp">Search</a></button></center>
			</div><center><button type="button" ><a href="RequestedList.jsp">Download</a></button></center>
