  ...
  line-height: 1.4;
	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<h3 class="h5 mb-4 text-center"><a  href="Adminpage.html">Home</a></h3>
					<div class="table-wrap">
					    ...
					    try{
					    	...
					    	String qry2 = "Select * from depttbl"; 
					    ...
					    <tbody>
					      ...
					      <tr>
					    			...
					    			<td class="border-bottom-0">
										<form action="adminpassupdate.jsp" method="post" autocomplete="off">
										<input type="text" name="pass"></input></td>
										<input type="hidden" name="mail" value="<%=rs1.getString(11) %>"> </td>
										<td> 
